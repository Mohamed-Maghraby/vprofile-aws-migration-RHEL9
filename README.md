...
name=Modern Erlang noarch for RHEL 9
...
[rabbitmq-el9]
name=RabbitMQ Server for RHEL 9
baseurl=https://yum1.rabbitmq.com/rabbitmq/el/9/$basearch https://yum2.rabbitmq.com/rabbitmq/el/9/$basearch
enabled=1
gpgcheck=1
repo_gpgcheck=1
...
[rabbitmq-el9-noarch]
name=RabbitMQ Server noarch for RHEL 9
baseurl=https://yum1.rabbitmq.com/rabbitmq/el/9/noarch https://yum2.rabbitmq.com/rabbitmq/el/9/noarch
enabled=1
gpgcheck=1
repo_gpgcheck=1
gpgkey=https://github.com/rabbitmq/signing-keys/releases/download/3.0/cloudsmith.rabbitmq-server.9F4587F226208342.key https://github.com/rabbitmq/signing-keys/releases/download/3.0/rabbitmq-release-signing-key.asc
...
if systemctl is-active --quiet firewalld 2>/dev/null; then
    ...
    echo "Firewalld is inactive; AWS Security Groups control TCP port 5672."
fi
...
sudo bash ~/vprofile-deployment/rabbitmq-rhel9.sh
```
